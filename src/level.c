...
static const int wall_positions_lvl3[][4] = {
    {64, 32, 128, 128},
    {48, -48, 96, 32},
    {252, -48, 96, 32},
    {236, 32, 128, 128},
...
void init_level(world_t *world) {
    ...
    } else if (world->current_level == 3) {
        // Niveau 3
        finish_line_y = -850;
        wall_positions = wall_positions_lvl3;
        murs_count = sizeof wall_positions_lvl3 / sizeof wall_positions_lvl3[0];
    } else {
        // Si le niveau non prévu, on réutilise le niveau 1
        finish_line_y = -960;
        murs_count = 0;
    }
